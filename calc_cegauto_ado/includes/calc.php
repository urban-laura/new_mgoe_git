...
if(isset($_GET['css'])) 
{
	...
	if (file_exists('css/cegauto_ado_' . $_GET['css'] . '.css')) 
	{
	  $output = str_replace('###cegauto-ado-css-source###', '_' . $_GET['css'], $output);
	}
	else 
	{
		$output = str_replace('###cegauto-ado-css-source###', '', $output);
	}
}
else 
{
